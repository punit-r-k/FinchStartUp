...
const SkyToggle = ({
  ...
  return (
    <StyledWrapper $size={size} className={cn("inline-flex", className)}>
      <label className="theme-switch" htmlFor={inputId}>
        <input
          id={inputId}
          type="checkbox"
...
const StyledWrapper = styled.div<{ $size: number }>`
  .theme-switch {
    ...
    --container-light-bg: #e09643;
    --container-night-bg: #24364c;
