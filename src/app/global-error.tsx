      ...
      <body className="bg-background text-foreground">
        <main className="mx-auto flex min-h-dvh w-full max-w-3xl items-center px-4 py-16">
          <section className="w-full rounded-[10px] border border-[#24364C]/10 bg-white/80 p-8 shadow-[0_24px_70px_rgba(36,54,76,0.08)] dark:border-white/10 dark:bg-[#182536]/78 dark:shadow-[0_24px_70px_rgba(0,0,0,0.26)]">
            <h1 className="text-2xl font-semibold text-[#24364C] dark:text-[#fff7ef]">
              Application error
            </h1>
            ...
            <button
              type="button"
              onClick={() => reset()}
              className="mt-6 rounded-md border border-[#24364C]/12 px-4 py-2 text-sm font-medium text-[#24364C] hover:bg-[#24364C]/5 dark:border-white/10 dark:text-[#fff7ef] dark:hover:bg-white/6"
            >
              Reload page
            </button>
          </section>
